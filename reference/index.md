...
- [`print(`*`<song_model>`*`)`](https://rabanheller.github.io/songR/reference/print.song_model.md)
  : Print a SONG Model
- [`summary(`*`<song_model>`*`)`](https://rabanheller.github.io/songR/reference/summary.song_model.md)
...
- [`songR_blobs`](https://rabanheller.github.io/songR/reference/songR_blobs.md)
  : Simulated Gaussian Blobs Dataset

## Package

- [`songR`](https://rabanheller.github.io/songR/reference/songR-package.md)
  [`songR-package`](https://rabanheller.github.io/songR/reference/songR-package.md)
